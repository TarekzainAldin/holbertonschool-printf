...
int _printf(const char *format, ...)
{
 ...
 {"c", print_char}, {"s", print_string}, {"%", print_unknown},{"d", print_decimal},
 {"i", print_decimal}, {"b", Dec_to_Bin}, {"o", Dec_to_Oct}, {"x", Dec_to_hex},
 {"X", Dec_to_HEX}, {"u", Unsigned}
	};
